...
#New error output after "cd before gem5 execute":
#warn: instruction 'movntdq_Mo_Vo' unimplemented
#info: Increasing stack size by one page.
#panic: Tried to read unmapped address 0xc.
#PC: 0x48ecc7, Instr:   TEST_M_I : ld   t1d, DS:[rdi + 0xc]
#Memory Usage: 16886428 KBytes
#Program aborted at tick 17483938000
#--- BEGIN LIBC BACKTRACE ---
#/home/tongxian/Projects/umd-memsys.gem5-modified/build/X86/gem5.opt(_Z15print_backtracev+0x15)[0x7378a5]
#/home/tongxian/Projects/umd-memsys.gem5-modified/build/X86/gem5.opt(_Z12abortHandleri+0x36)[0x7416d6]
#/lib/x86_64-linux-gnu/libpthread.so.0(+0x143c0)[0x7f3199a0a3c0]
#/lib/x86_64-linux-gnu/libc.so.6(gsignal+0xcb)[0x7f319913b03b]
#/lib/x86_64-linux-gnu/libc.so.6(abort+0x12b)[0x7f319911a859]
